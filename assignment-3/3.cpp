...
/*
    This code is given by assignment, and the assignment was to design the "Commodity"
    class to make the program runnable and produce the output given in the bottom comment.
*/
